...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [GW] = { ENCODER_CCW_CW(_______, _______),           ENCODER_CCW_CW(_______, _______) },
...
/*
 * Game B
 * Made for games with arrow keys as movement keys
 * ,-----------------------------------------.                               ,-----------------------------------------.
...
/*
 * Write layers for the gaming layers
 * ,-----------------------------------------.                               ,-----------------------------------------.
 * |  `   |   1  |   2  |   3  |   4  |   5  |                               |   6  |   7  |   8  |   9  |   0  | Bspc |
 * |------+------+------+------+------+------|                               |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |                               |   Y  |   U  |   I  |   O  |   P  |  \   |
...
[R] = LAYOUT(
    ...
    _______,XXXXXXX,XXXXXXX,AG_TOGG,XXXXXXX,TG(GB) ,XXXXXXX,    XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,_______,
                    _______,_______,_______,_______,_______,    _______,_______,_______,_______,_______
),
};
