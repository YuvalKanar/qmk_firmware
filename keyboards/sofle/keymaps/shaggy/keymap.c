...
tap_dance_action_t tap_dance_actions[] = {
  [0] = ACTION_TAP_DANCE_LAYER_MOVE(KC_ENT, B),
};
 ...
 * `-------------+------+------+------+------|       |               |       |------+------+------+------+-------------'
 *               | ____ | ____ | ____ | ____ | Space |               | TD(0) | ____ | ____ | ____ | ____ |
 *               `-----------------------------------'               '-----------------------------------'
 */
...
[GA] = LAYOUT(
    ...
    KC_B   ,KC_LSFT,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,_______,    _______,_______,_______,_______,_______,_______,_______,
                    _______,_______,_______,_______,KC_SPC ,    TD(0)  ,_______,_______,_______,_______
),
 ...
 * | ____ | ____ | ____ | ____ | ____ | ____ |-------|               |-------| ____ | ____ | ____ | ____ | ____ | ____ |
 * `-------------+------+------+------+------|       |               |       |------+------+------+------+-------------'
 *               | ____ | ____ | ____ | ____ | TD(0) |               | ____  | ____ | ____ | ____ | ____ |
 *               `-----------------------------------'               '-----------------------------------'
 */
...
[GB] = LAYOUT(
    ...
    _______,_______,_______,_______,_______,_______,_______,    _______,_______,_______,_______,_______,_______,_______,
                    _______,_______,_______,_______,TD(0)  ,    _______,_______,_______,_______,_______
),
